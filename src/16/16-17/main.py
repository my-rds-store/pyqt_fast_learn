...
from PyQt4.QtGui import QApplication, QListView, QPushButton
...
if __name__ == '__main__':
    ...
    itemV.show()
    # 从第3行处,插入2行
    stdItemModel.insertRows(0, 8)
    # stdItemModel.insertRow(9)

    # 获取3行０列  index
    index = stdItemModel.index(3, 0)
    stdItemModel.setData(index,QVariant("abc1234"))
    index = stdItemModel.index(4, 0)
    stdItemModel.setData(index,QVariant("tttt1234"))

    # # 删除行
    # stdItemModel.removeRows(5,2)
